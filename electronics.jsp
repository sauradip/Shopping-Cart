...
<d:form action="checkout">
    <d:submit value="Proceed to Checkout"/>
</d:form>
        <html>
            <head>
                        ...
                        <div class="col-sm-3" style="padding:4px;">
                            <div class="col-item">
                                <div class="photo">
                                    ...
                                    <d:a action="detail?id=%{pid}"><img src="<d:url action="empPic?id=%{pid}"/>" height="400" width="200"/></d:a>
                                </div>
                                <div class="info">
                                    <div class="row">
                        ...
                        <div class="col-sm-3" style="padding:4px;">
                            <div class="col-item">
                                <div class="photo">
                                    ...
                                    <d:a action="detail?id=%{pid}"><img src="<d:url action="empPic?id=%{pid}"/>" height="150" width="200"/></d:a>
                                </div>
                                <div class="info">
                                    <div class="row">
                        ...
                        <div class="col-sm-3" style="padding:4px;">
                            <div class="col-item">
                                <div class="photo">
                                    ...
                                    <d:a action="detail?id=%{pid}"><img src="<d:url action="empPic?id=%{pid}"/>" height="300" width="300"/></d:a>
                                </div>
                                <div class="info">
                                    <div class="row">
